...
namespace ropufu::aftermath::probability
{
    namespace detail
    {
        ...
        template <bool t_is_enabled, typename t_derived_type, typename t_key_type, typename t_probability_type>
        struct ordering_module
        {
        protected:
            detail::order_statistic<t_key_type, t_probability_type, t_is_enabled> m_order_statistic = { };
        };

        /** @brief Ordering module for \c empirical_measure. */
        template <typename t_derived_type, typename t_key_type, typename t_probability_type>
        struct ordering_module<true, t_derived_type, t_key_type, t_probability_type>
        {
            using type = ordering_module<true, t_derived_type, t_key_type, t_probability_type>;
        ...
        {
        protected:
            detail::linear_statistic<t_key_type, t_count_type, t_sum_type, t_mean_type, t_is_enabled> m_linear_statistic = { };
        };
        
        /** @brief Linear module for \c empirical_measure. */
        template <typename t_derived_type, typename t_key_type, typename t_count_type, typename t_sum_type, typename t_mean_type>
        struct linear_module<true, t_derived_type, t_key_type, t_count_type, t_sum_type, t_mean_type>
        {
            using type = linear_module<true, t_derived_type, t_key_type, t_count_type, t_sum_type, t_mean_type>;
            using derived_type = t_derived_type;
        ...
        {
        protected:
            using variance_helper_type = detail::variance_statistic<t_key_type, t_count_type, t_sum_type, t_mean_type, t_is_enabled>;
        };
        
        /** @brief Variance module for \c empirical_measure. */
        template <typename t_derived_type, typename t_key_type, typename t_count_type, typename t_sum_type, typename t_mean_type>
        struct variance_module<true, t_derived_type, t_key_type, t_count_type, t_sum_type, t_mean_type>
        {
            using type = variance_module<true, t_derived_type, t_key_type, t_count_type, t_sum_type, t_mean_type>;
            using derived_type = t_derived_type;
    ...
    struct empirical_measure
        : public detail::ordering_module<t_is_ordered, ROPUFU_EMPIRICAL_MEASURE_TYPEDEF, t_key_type, t_probability_type>,
        public detail::linear_module<t_is_linear_space, ROPUFU_EMPIRICAL_MEASURE_TYPEDEF, t_key_type, t_count_type, t_sum_type, t_mean_type>,
        public detail::variance_module<t_has_variance, ROPUFU_EMPIRICAL_MEASURE_TYPEDEF, t_key_type, t_count_type, t_sum_type, t_mean_type>
    {
