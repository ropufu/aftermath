    ...
    namespace aftermath
    {
        namespace random
        {
            ...
            struct sampler_normal
            {
                ...
                using type = sampler_normal<t_n_boxes, t_result_type, t_uniform_type, t_bounds_type, t_diameter>;
                using distribution_type = probability::dist_normal<t_result_type>;
