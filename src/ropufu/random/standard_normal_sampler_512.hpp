...
#define ROPUFU_AFTERMATH_RANDOM_STANDARD_NORMAL_SAMPLER_512_HPP_INCLUDED
...
namespace ropufu::aftermath::random
{
    ...
    struct standard_normal_sampler_512;
    ...
    struct standard_normal_sampler_512 :
        public ziggurat_sampler<
            standard_normal_sampler_512<t_engine_type, t_value_type, t_probability_type, t_expectation_type>,
            t_engine_type,
    ...
    {
        using type = standard_normal_sampler_512<t_engine_type, t_value_type, t_probability_type, t_expectation_type>;
...
#endif // ROPUFU_AFTERMATH_RANDOM_STANDARD_NORMAL_SAMPLER_512_HPP_INCLUDED
