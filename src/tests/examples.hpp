...
#ifndef ROPUFU_AFTERMATH_TESTS_EXAMPLES_HPP_INCLUDED
#define ROPUFU_AFTERMATH_TESTS_EXAMPLES_HPP_INCLUDED
...
#endif // ROPUFU_AFTERMATH_TESTS_EXAMPLES_HPP_INCLUDED
