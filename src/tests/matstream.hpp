...
#ifndef ROPUFU_AFTERMATH_TESTS_MATSTREAM_HPP_INCLUDED
#define ROPUFU_AFTERMATH_TESTS_MATSTREAM_HPP_INCLUDED
...
namespace ropufu::aftermath::tests
{
    ...
    public:
        explicit matstream_tester(const std::string& filename) noexcept
            : m_filename(filename)
        {
        } // matstream_tester(...)
...
#endif // ROPUFU_AFTERMATH_TESTS_MATSTREAM_HPP_INCLUDED
