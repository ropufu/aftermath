...
#define ROPUFU_AFTERMATH_TESTS_PROBABILITY_MOMENT_STATISTIC_TYPES  \
    std::pair<std::size_t, double>,                                \
    std::pair<float, double>,                                      \
    std::pair<double, long double>                                 \


TEST_CASE_TEMPLATE("testing moment statistic for scalar types", pair_t, ROPUFU_AFTERMATH_TESTS_PROBABILITY_MOMENT_STATISTIC_TYPES)
{
    using observation_type = typename pair_t::first_type;
    using statistic_type = typename pair_t::second_type;
...
TEST_CASE_TEMPLATE("testing moment statistic for matrix types", pair_t, ROPUFU_AFTERMATH_TESTS_PROBABILITY_MOMENT_STATISTIC_TYPES)
{
    using observation_scalar_type = typename pair_t::first_type;
    using statistic_scalar_type = typename pair_t::second_type;
